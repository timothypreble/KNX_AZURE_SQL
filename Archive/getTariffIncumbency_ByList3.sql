...
==============================================================================================================================
*/
ALTER PROCEDURE [dbo].[getTariffIncumbency_ByList3] ( @inbound KNX_RFP_Request READONLY) AS
...
--FROM KRAFT_HEINZ_RFP_TP_20230810
-- FROM westrock_RFP_CPT_Playfile‰
FROM PepsiCo_20230821

update PepsiCo_20230821 SET customernumber = 32510
--SELECT * FROM @inbound
--1344960 (88)
--1253937 (0)
--32510 (132)
