...
==============================================================================================================================
 ...
 need to fix all the updates that match on state to make sure that the 
 tariff lane does not have city/zip only state.  Did this in history.
...
==============================================================================================================================
*/
ALTER PROCEDURE [dbo].[getTariffIncumbency_ByList_2] ( @inbound KNX_RFP_Request READONLY) AS


/* TEST */
--DECLARE @inbound KNX_RFP_Request
--INSERT INTO @inbound (
--	        traceID , laneId , companyCode , customerNumber , originCity
--	    , originState , originZip , originMisc , destinationCity
--	    , destinationState , destinationZip , destinationMisc , equipmentType , customerMiles)
--SELECT *
----FROM KRAFT_HEINZ_RFP_TP_20230810
--FROM westrock_RFP_CPT_Playfile
/* TEST */
...
FROM [dbo].[tariff_header] AS TH	
  ...
  JOIN [dbo].[tariff_commitment] TC ON th.tariff_header_Id = tc.tariff_header_Id	--**NEW**
